    ...
    <div>
      <span>
        ...
        >
          ...
          >
            <h4 className="mt-1 mb-1"><b>Cadastro Centro Custo</b></h4>
          </ModalHeader>
          <ModalBody>
            <Row>
              <Col md="6" className="mt-1">
                <FormGroup>
                  ...
                  <Input
                    ...
                    onChange={(e) => setCentroCusto({ ...centroCusto, [e.target.name]: e.target.value.toUpperCase() })}
                  />
                </FormGroup>
              </Col>
              <Col md="6" className="mt-1">
                <FormGroup>
                  ...
                  <Select
                    ...
                    options={options}
                    isSearchable
                    value={options.filter((option) => option.value === centroCusto.Inativo)}
                    onChange={(e) => {
                      setCentroCusto({ ...centroCusto, Inativo: e.value })
                    }}
                  />
                </FormGroup>
              </Col>
