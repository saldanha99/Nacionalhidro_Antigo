...
const PropostasReprovadas = (props) => {
  ...
  useEffect(() => {
    if (selectedTipo === 'Reprovadas') {
      props.buscarPropostas(Enum_StatusPropostas.Reprovada, user)
